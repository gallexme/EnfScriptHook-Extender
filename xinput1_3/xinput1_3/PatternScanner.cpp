...
std::vector<uintptr_t> PatternScanner::find( std::vector<std::string>& strings,  std::string& moduleName)
{
...
uintptr_t hl::PatternScanner::findString(std::string& str, std::string& moduleName, int instance)
{
...
std::map<std::string, uintptr_t> PatternScanner::findMap( std::vector<std::string>& strings,
...
uintptr_t hl::FindPatternMask(const char* byteMask, const char* checkMask, std::string& moduleName, int instance)
{
	uintptr_t result = 0;
...
uintptr_t hl::FindPattern(std::string& pattern, std::string& moduleName, int instance)
{
	uintptr_t result = 0;
	for (const auto& region : hl::GetCodeRegions(moduleName))
	{
...
uintptr_t hl::FindPattern(std::string& pattern, uintptr_t address, size_t len, int instance)
{
...
uintptr_t hl::FollowRelativeAddress(uintptr_t adr, int trail)
{
 ...
 std::vector<hl::MemoryRegion>& hl::GetCodeRegions( std::string& moduleName)
{
